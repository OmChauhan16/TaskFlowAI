...
//     Save, X, Edit3, Shield, Bell, Key, LogOut,
...
//                     <span className="text-sm">{formData[name] || <span className="text-gray-400 italic">Not set</span>}</span>
//                 </div>
//             )}
//         </div>
//     );
...
//                                                 disabled={saving}
//                                                 className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition font-medium disabled:opacity-50"
//                                             >
...
//                                             disabled={saving}
//                                             className="px-6 py-2.5 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition font-medium disabled:opacity-50"
//                                         >
...
//                                         </div>
//                                         <button className="px-4 py-2 border border-red-300 text-red-600 text-sm rounded-lg hover:bg-red-50 transition font-medium">
//                                             Delete Account
//                                         </button>
//                                     </div>
//                                 </div>
...
const ProfilePage = () => {
    ...
    const handleSaveProfile = async () => {
        ...
        try {
            const data = await updateProfile(formData);
            setUser(data.user); // Make sure setUser is available from AuthContext
            setIsEditing(false);
            toast.success('Profile updated successfully!');
        } catch (err) {
            toast.error('Failed to update profile');
